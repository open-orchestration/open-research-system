...
[Skip to main content](https://docs.langchain.com/oss/python/langgraph/graph-api#content-area)
...
## On this page
  * [Graphs](https://docs.langchain.com/oss/python/langgraph/graph-api#graphs)
    * [StateGraph](https://docs.langchain.com/oss/python/langgraph/graph-api#stategraph)
    * [Compiling your graph](https://docs.langchain.com/oss/python/langgraph/graph-api#compiling-your-graph)
  * [State](https://docs.langchain.com/oss/python/langgraph/graph-api#state)
    ...
    * [Multiple schemas](https://docs.langchain.com/oss/python/langgraph/graph-api#multiple-schemas)
    * [Reducers](https://docs.langchain.com/oss/python/langgraph/graph-api#reducers)
    * [Default reducer](https://docs.langchain.com/oss/python/langgraph/graph-api#default-reducer)
    * [Overwrite](https://docs.langchain.com/oss/python/langgraph/graph-api#overwrite)
    * [Working with messages in graph state](https://docs.langchain.com/oss/python/langgraph/graph-api#working-with-messages-in-graph-state)
    * [Why use messages?](https://docs.langchain.com/oss/python/langgraph/graph-api#why-use-messages)
    * [Using messages in your graph](https://docs.langchain.com/oss/python/langgraph/graph-api#using-messages-in-your-graph)
    * [Serialization](https://docs.langchain.com/oss/python/langgraph/graph-api#serialization)
    * [MessagesState](https://docs.langchain.com/oss/python/langgraph/graph-api#messagesstate)
  * [Nodes](https://docs.langchain.com/oss/python/langgraph/graph-api#nodes)
    * [Re-execution and idempotency](https://docs.langchain.com/oss/python/langgraph/graph-api#re-execution-and-idempotency)
    * [Using tasks in nodes](https://docs.langchain.com/oss/python/langgraph/graph-api#using-tasks-in-nodes)
    * [START node](https://docs.langchain.com/oss/python/langgraph/graph-api#start-node)
    * [END node](https://docs.langchain.com/oss/python/langgraph/graph-api#end-node)
    * [Node caching](https://docs.langchain.com/oss/python/langgraph/graph-api#node-caching)
  * [Edges](https://docs.langchain.com/oss/python/langgraph/graph-api#edges)
    * [Normal edges](https://docs.langchain.com/oss/python/langgraph/graph-api#normal-edges)
    * [Conditional edges](https://docs.langchain.com/oss/python/langgraph/graph-api#conditional-edges)
    * [Entry point](https://docs.langchain.com/oss/python/langgraph/graph-api#entry-point)
    * [Conditional entry point](https://docs.langchain.com/oss/python/langgraph/graph-api#conditional-entry-point)
  * [Send](https://docs.langchain.com/oss/python/langgraph/graph-api#send)
  * [Command](https://docs.langchain.com/oss/python/langgraph/graph-api#command)
    * [Return from nodes](https://docs.langchain.com/oss/python/langgraph/graph-api#return-from-nodes)
    * [update and goto](https://docs.langchain.com/oss/python/langgraph/graph-api#update-and-goto)
    * [graph](https://docs.langchain.com/oss/python/langgraph/graph-api#graph)
    * [Input to invoke or stream](https://docs.langchain.com/oss/python/langgraph/graph-api#input-to-invoke-or-stream)
    * [resume](https://docs.langchain.com/oss/python/langgraph/graph-api#resume)
    * [Return from tools](https://docs.langchain.com/oss/python/langgraph/graph-api#return-from-tools)
  * [Graph migrations](https://docs.langchain.com/oss/python/langgraph/graph-api#graph-migrations)
  * [Runtime context](https://docs.langchain.com/oss/python/langgraph/graph-api#runtime-context)
    ...
    * [Accessing and handling the recursion counter](https://docs.langchain.com/oss/python/langgraph/graph-api#accessing-and-handling-the-recursion-counter)
    * [How it works](https://docs.langchain.com/oss/python/langgraph/graph-api#how-it-works)
    * [Accessing the current step counter](https://docs.langchain.com/oss/python/langgraph/graph-api#accessing-the-current-step-counter)
    * [Proactive recursion handling](https://docs.langchain.com/oss/python/langgraph/graph-api#proactive-recursion-handling)
    * [Proactive vs reactive approaches](https://docs.langchain.com/oss/python/langgraph/graph-api#proactive-vs-reactive-approaches)
    * [Other available metadata](https://docs.langchain.com/oss/python/langgraph/graph-api#other-available-metadata)
  * [Visualization](https://docs.langchain.com/oss/python/langgraph/graph-api#visualization)
  * [Observability and Tracing](https://docs.langchain.com/oss/python/langgraph/graph-api#observability-and-tracing)
  * [Learn more](https://docs.langchain.com/oss/python/langgraph/graph-api#learn-more)
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#compiling-your-graph)
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#schema)
Schema
The main documented way to specify the schema of a graph is by using a [`TypedDict`](https://docs.python.org/3/library/typing.html#typing.TypedDict). If you want to provide default values in your state, use a [`dataclass`](https://docs.python.org/3/library/dataclasses.html). We also support using a Pydantic [`BaseModel`](https://docs.langchain.com/oss/python/langgraph/use-graph-api#use-pydantic-models-for-graph-state) as your graph state if you want recursive data validation (though note that Pydantic is less performant than a `TypedDict` or `dataclass`). By default, the graph will have the same input and output schemas. If you want to change this, you can also specify explicit input and output schemas directly. This is useful when you have a lot of keys, and some are explicitly for input and others for output. See the [guide](https://docs.langchain.com/oss/python/langgraph/use-graph-api#define-input-and-output-schemas) for more information.
...
**Private channels are not redacted when streaming.** Input, output, and private schemas constrain what each node _reads_ (its input schema) and what `invoke` _returns_ (the output schema). They do **not** hide channels from `stream`.When you stream with `stream_mode="values"`, the graph emits **all** of its state channels by default, including private ones, because values streaming defaults to the full set of state channels rather than the output schema. This is why a private channel like `bar` is hidden by `invoke` but visible while streaming:
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#overwrite)
Overwrite
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#why-use-messages)
Why use messages?
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#using-messages-in-your-graph)
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#serialization)
Serialization
In addition to keeping track of message IDs, the [`add_messages`](https://reference.langchain.com/python/langgraph/graph/message/add_messages) function will also try to deserialize messages into LangChain `Message` objects whenever a state update is received on the `messages` channel. For more information, see [LangChain serialization/deserialization](https://python.langchain.com/docs/how_to/serialization/). This allows sending graph inputs / state updates in the following format:
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#start-node)
`START` node
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#end-node)
`END` node
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#node-caching)
Node caching
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#entry-point)
Entry point
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#conditional-entry-point)
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#return-from-nodes)
Return from nodes
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#update-and-goto)
`update` and `goto`
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#graph)
`graph`
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#input-to-invoke-or-stream)
...
### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#return-from-tools)
Return from tools
...
## 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#graph-migrations)
Graph migrations
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#how-it-works)
How it works
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#accessing-the-current-step-counter)
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#proactive-recursion-handling)
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#proactive-vs-reactive-approaches)
...
#### 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#other-available-metadata)
...
## 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#visualization)
Visualization
...
## 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#observability-and-tracing)
Observability and Tracing
To trace, debug and evaluate your agents, use [LangSmith](https://docs.langchain.com/langsmith/observability).
## 
[​](https://docs.langchain.com/oss/python/langgraph/graph-api#learn-more)
Learn more
...
YesNo
[ Choosing between Graph and Functional APIs Previous ](https://docs.langchain.com/oss/python/langgraph/choosing-apis)[ Use the graph API Next ](https://docs.langchain.com/oss/python/langgraph/use-graph-api)
⌘I
[Docs by LangChain home page![light logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-dark-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=5babf1a1962208fd7eed942fa2432ecb)![dark logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-light-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=0bcd2a1f2599ed228bcedf0f535b45b1)](https://docs.langchain.com/)
