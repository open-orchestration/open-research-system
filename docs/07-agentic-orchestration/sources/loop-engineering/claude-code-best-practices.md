...
## On this page
  ...
  * [Automate and scale](https://code.claude.com/docs/en/best-practices#automate-and-scale)
    ...
    * [Run autonomously with auto mode](https://code.claude.com/docs/en/best-practices#run-autonomously-with-auto-mode)
    * [Add an adversarial review step](https://code.claude.com/docs/en/best-practices#add-an-adversarial-review-step)
