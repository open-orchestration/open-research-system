# CSL-JSON formal JSON Schema (csl-data.json)

Official Citation Style Language input schema (citation-style-language/schema, schemas/input/csl-data.json). Defines the fixed CSL item-type enumeration, required fields (type, id), and the full variable set.
