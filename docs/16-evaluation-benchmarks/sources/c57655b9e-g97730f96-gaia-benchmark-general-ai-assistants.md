...
feasiblewhenincreasingthetaskcomplexity,e.g. intermsofoutputlengthorrequiredskills: howtoevaluatea
...
2019).
1GPT4does86.4%onMMLU.Humannon-specialistaccuracyonthebenchmarkisonly34.5%Expert-levelhumanperformance
isestimatedat89.8%.
2SeeforexamplethecaseofHellaswag.
1
3202
voN
12
...
standardsasreportedbyWikipediain2020? Answeras+or-anumberrounded
...
- Non-gameability. Answeringthequestionsrequiressuccessfulcompletionofsomenumberofsteps, which
...
limitation(Zhengetal.,2023). However, thislattersolutionreliesonusingamorecapableLLM(oftenGPT4)
...
beats,onmosttasks,mosthumanexpertswhoaregiventimettoperformthetask
3
...
3 GAIA
Thissectioncoversthedesignandcontentof GAIA,aswellasguidelinesforcreatingquestionsandassociated
challenges.
...
questions. GAIAattemptstocircumventdifferentpitfallsofLLMsevaluation. Itiscomposedof466questions
...
Design choices. GAIAresultsbothfromtheneedforrevisedAIbenchmarks, andtheobservedshortcomings
of LLM evaluation.
Our first principle is to target questions that are conceptually simple although potentially tedious for humans,
yetvaried,rootedintherealworldandchallengingforcurrentAIsystems. Thisallowstofocusonfundamental
...
informationgatheredfromdifferentandvarioussources,suchasprovideddocumentsortheopenandchanging
...
frompre-trainingdata, andthepossibilitytocheckthereasoningtracemitigatethisrisk. Incontrast, multiple
...
| --- | ------------- | --- | --------- | --- | ------ | ------ | -------- | --- | --- |
Figure 2 ToanswerGAIA,anAIassistantsuchasGPT4(hereequippedwithacodeinterpreter)needstocompletea
...
|     |              |     |     | 6                              |     | Level 1 |
| --- | ------------ | --- | --- | ------------------------------ | --- | ------- |
|     | Web browsing |     | 355 | desu sloot tnereffid fo rebmuN |     |         |
Level 2
5
Level 3
|     | Coding | 154 |     |     |     |     |
...
GAIA
corresponds to a question. At a given location, the size of the dots are proportional to the number of questions,
...
Capabilitiescoverage. ScoringperfectlyonGAIArequiresadvancedreasoning,multi-modalityunderstanding,
coding capabilities and generally tool use, e.g web browsing, for which we provide a more precise definition
inAppendixC.WealsoincludequestionsrequiringtoprocessvarieddatamodalitiessuchasPDFs,spreadsheets,
but also images, videos or audio, whose distribution is reported in Appendix C (Figure 6). Figure 3 (left) is
GAIA,
an overview of these capabilities. Although web browsing is a key component of we do not require
assistantstoperformactionsotherthan“clicks”onawebsitesuchasuploadingafile, postacommentorbook
a meeting. Testing these capabilities in real environments while avoiding spamming websites requires careful
considerationthatweleaveforfuturework,andreferthereadertorecentworksproposingclosedenvironments
...
Craftingquestions. Ourquestionsarecreatedbyhumans5 andaimtoreflectrealisticusecasesofAIassistants.
...
perfect, demonstratingthatGAIAissimplefornonexperts. Weestimatethecreationofaquestion, including
...
updatedbetweenthemomentthequestioniscreatedandthemomentitisaskedtoanAIassistant,potentially
...
5Moreprecisely,inacollaborationbetweenourteamsandcompensatedannotatorsfromSurgeAI.
7
...
Results. OurevaluationcanbefoundinFigure4,withmoredetailsinTable4(AppendixD.1). Ourproposed
...
resultsfromwhichthecorrectanswercanbe
| deductedforLevel1,yetdoesnotworkwhen |             |      |         |     |          |     | 0.200 |     |     |     |     |     |     |
| ------------------------------------ | ----------- | ---- | ------- | --- | -------- | --- | ----- | --- | --- | --- | --- | --- | --- |
| it comes                             | to slightly | more | complex |     | queries, |     |       |     |     |     |     |     |     |
0.175
andisalsoslightlyslowerthanatypicalLLM
0.150
| assistant  | since    | the user   | has to | skim           | through |     |                 |     |     |     |     |     |     |
| ---------- | -------- | ---------- | ------ | -------------- | ------- | --- | --------------- | --- | --- | --- | --- | --- | --- |
| the first  | search   | results.   | This   | confirms       | the     |     | )%( erocS 0.125 |     |     |     |     |     |     |
| potential  | of LLM   | assistants |        | as competitors |         |     | 0.100           |     |     |     |     |     |     |
| for search | engines. |            |        |                |         |     |                 |     |     |     |     |     |     |
0.075
ThediscrepancybetweenGPT4resultswith-
0.050
| out plugins | and | the others | demonstrate |     | that |     |     |     |     |     |     |     |     |
| ----------- | --- | ---------- | ----------- | --- | ---- | --- | --- | --- | --- | --- | --- | --- | --- |
0.025
augmentingLLMsviatoolAPIsoraccessto
| the web        | improves | answer     | accuracy, |            | and un- |     | 0.000                    |      |          |              |                |                |     |
| -------------- | -------- | ---------- | --------- | ---------- | ------- | --- | ------------------------ | ---- | -------- | ------------ | -------------- | -------------- | --- |
|                |          |            |           |            |         |     | Diverse filetype reading |      | N/A      | Web browsing | Coding         | Multi-modality |     |
...
pendix D.1. The discrepancy with humans models for web browsing are mostly due to correct memorization
|     |     |     |     |     |     | of  | information | required | to  | complete | intermediate | steps. |     |
| --- | --- | --- | --- | --- | --- | --- | ----------- | -------- | --- | -------- | ------------ | ------ | --- |
suggeststheworkneededtofullyunlockthis
potential.
...
5 Discussion
GAIA
Designing led us to think about current and future paradigm of AI systems evaluation.
...
hundredsofquestionsthathavebeencarefullycuratedandselected. Bycomparison,amoremassivebenchmark
...
AI,anotherimportantexamplebeingimages(Steinetal.,2023). Huetal.(2023)makeastepinthatdirection,
...
Vodrahalli,XuezhiWang,PidongWang,ZiruiWang,TaoWang,JohnWieting,YuhuaiWu,KelvinXu,YunhanXu,
...
Chi-MinChan,WeizeChen,YushengSu,JianxuanYu,WeiXue,ShanghangZhang,JieFu,andZhiyuanLiu. ChatEval:
...
Advances in Cryptology — CRYPTO’ 92,pages139–147,Berlin,Heidelberg,1993.SpringerBerlinHeidelberg. ISBN
978-3-540-48071-6.
...
YingqiangGe,WenyueHua,KaiMei,JianchaoJi,JuntaoTan,ShuyuanXu,ZelongLi,andYongfengZhang. Openagi:
...
YushiHu,BenlinLiu,JungoKasai,YizhongWang,MariOstendorf,RanjayKrishna,andNoahASmith.Tifa: Accurate
...
Yang,ShudanZhang,XiangDeng,AohanZeng,ZhengxiaoDu,ChenhuiZhang,ShengShen,TianjunZhang,YuSu,
HuanSun,MinlieHuang,YuxiaoDong,andJieTang. Agentbench: Evaluatingllmsasagents. arXiv preprint arXiv:
2308.03688, 2023a.
...
YotamPerlitz,ElronBandel,ArielGera,OfirArviv,LiatEin-Dor,EyalShnarch,NoamSlonim,MichalShmueli-Scheuer,
...
comprehensionoftext. InProceedings of the 2016 Conference on Empirical Methods in Natural Language Processing,
...
KurtShuster,JingXu,MojtabaKomeili,DaJu,EricMichaelSmith,StephenRoller,MeganUng,MoyaChen,Kushal
...
AletheaPower,AlexRay,AlexWarstadt,AlexanderW.Kocurek,AliSafaya,AliTazarv,AliceXiang,AliciaParrish,
...
DenisKleyko,DenizYuret,DerekChen,DerekTam,DieuwkeHupkes,DigantaMisra,DilyarBuzan,DimitriCoelho
Mollo, Diyi Yang, Dong-Ho Lee, Dylan Schrader, Ekaterina Shutova, Ekin Dogus Cubuk, Elad Segal, Eleanor
Hagerman,ElizabethBarnes,ElizabethDonoway,ElliePavlick,EmanueleRodola`,EmmaLam,EricChu,EricTang,
...
Ramirez-Quintana,MarieTolkiehn,MarioGiulianelli,MarthaLewis,MartinPotthast,MatthewLLeavitt,Matthias
...
Bevilacqua,MichihiroYasunaga,MihirKale,MikeCain,MimeeXu,MiracSuzgun,MitchWalker,MoTiwari,Mohit
...
NuanWen,OliverZhang,OmarAgha,OmarElbaghdadi,OmerLevy,OwainEvans,PabloAntonioMorenoCasares,
ParthDoshi,PascaleFung,PaulPuLiang,PaulVicol,PegahAlipoormolabashi,PeiyuanLiao,PercyLiang,PeterW
...
Bowman,SamuelSternSchoenholz,SanghyunHan,SanjeevKwatra,SarahA.Rous,SarikGhazarian,SayanGhosh,
...
Nkinyili,TimoSchick,TimofeiKornev,TitusTunduny,TobiasGerstenberg,TrentonChang,TrishalaNeeraj,Tushar
...
benchmarkandanalysisplatformfornaturallanguageunderstanding. InProceedings of the 2018 EMNLP Workshop
...
AlexWang,YadaPruksachatkun,NikitaNangia,AmanpreetSingh,JulianMichael,FelixHill,OmerLevy,andSamuel
...
QiantongXu,FengluHong,BoLi,ChangranHu,ZhengyuChen,andJianZhang. Onthetoolmanipulationcapability
...
YuchenZhuang,YueYu,KuanWang,HaotianSun,andChaoZhang. ToolQA:ADatasetforLLMQuestionAnswering
...
GAIA
building required the work of Curators, who devised the questions and their answer, and Annotators,
...
• Multi-modality: toolsrelatedtounderstandingdatamodalityotherthantext. Examples: A speech-to-text
...
Time versus number of tools to answer Time versus number of steps to answer
| 60                             |     |     |     |     | Level 2 | 60                             |     |     |     |
| ------------------------------ | --- | --- | --- | --- | ------- | ------------------------------ | --- | --- | --- |
| )setunim( rewsna ot nekat emiT |     |     |     |     |         | )setunim( rewsna ot nekat emiT |     |     |     |
Level 1
Level 3
| 50  |     |     |     |     |     | 50  |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Number of tool used to answer Number of steps taken to answer
Figure 7 Using multiple tools does not necessarily involve Figure 8 Unsurprisingly, the number of steps taken to
more time to answer a question. answer is correlated to the time taken.
| D Extended |     | description |     | of our | question |     | design framework |     |     |
| ---------- | --- | ----------- | --- | ------ | -------- | --- | ---------------- | --- | --- |
GAIAquestionswedevisedourselves,
| Questioncreationphase. |      |               | Weprovidedtheannotatorswithaseedsetof |     |     |     |     |     |     |
| ---------------------- | ---- | ------------- | ------------------------------------- | --- | --- | --- | --- | --- | --- |
...
removed otherwise.
Weestimatethecreationofaquestion,includingitsvalidationbytwosupplementaryannotatorsandpotential
...
Question WhatwastheactualenrollmentcountoftheclinicaltrialonH.pyloriinacnevulgarispatients
|          |              | from     | Jan-May   | 2018 as        | listed on the | NIH website? |     |
| -------- | ------------ | -------- | --------- | -------------- | ------------- | ------------ | --- |
| File     |              | None     |           |                |               |              |     |
| Level    |              | 1        |           |                |               |              |     |
...
| ----- | ------------- | ---------- | ------------- | ---------------- |
GAIA
Figure 9 Proper web search is very effective to answer questions. The reasoning trace was obtained with the
...
| ---------- | --- | ------- | ----- | -------- | --- | ----- | ------------ | ---- | ---- | ------ |
Solution Approach: Since the removed cube hastwo colorson its faces, itmust be anedge cube. To determine
